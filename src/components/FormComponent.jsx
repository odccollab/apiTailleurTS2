...
const FormComponent = () => {
    ...
    const { user, articles, addArticle } = useAuth();
    ...
    useEffect(() => {
        ...
        if (user && user.type) {
            ...
            setIsSeller(user.type.toLowerCase() === 'seller' || user.type.toLowerCase() === 'vendeur');
        }
    }, [user]);
        ...
        return (
            <div className="right-chat-form">
                <div className="form-header">
                    ...
                    <p>Seuls les vendeurs ont accès à ce formulaire.</p>
                    <p>Votre rôle actuel : {user ? user.type : 'non connecté'}</p>
                </div>
            </div>
        );
    }
