const FriendRequestCard = ({ userImage, userName, mutualFriends }) => {
    return (
        <div className="card w-100 shadow-xss rounded-xxl border-0 mb-3">
            ...
            <div className="card-body d-flex pt-4 ps-4 pe-4 pb-0 border-top-xs bor-0">
                ...
                <h4 className="fw-700 text-grey-900 font-xssss mt-1">{userName} <span className="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">{mutualFriends} mutual friends</span></h4>
            </div>
