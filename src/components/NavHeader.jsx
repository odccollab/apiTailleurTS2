...
const NavHeader = () => {
    ...
    const handleSearchChange = (e) => {
        ...
        // Redirection vers la page de résultats de recherche avec le terme de recherche
        if (query.length > 0) {
    ...
    return (
        <div className="nav-header bg-white shadow-xs border-0 p-2">
            ...
            <form action="#" className="float-left header-search">
                <div className="form-group mb-0 icon-input">
                    ...
                    <input
                        ...
                        value={searchQuery} // Lier à l'état
                        onChange={handleSearchChange} // Appel à chaque changement
                    />
                </div>
            </form>
            ...
            <RouterLink to="#" className="p-2 text-center ms-auto menu-icon" id="dropdownMenu3" data-bs-toggle="dropdown" aria-expanded="false">
